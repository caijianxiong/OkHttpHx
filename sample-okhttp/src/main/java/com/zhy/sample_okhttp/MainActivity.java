...
public class MainActivity extends AppCompatActivity {
    ...
    private String mBaseUrl02 = "http://mjxc.yun2win.com/";
    ...
    public void getUser(View view) {
        String url = mBaseUrl + "v1/ad/getTvAd/coocaa";
        OkHttpUtils
                .post()//
                .url(url)//
                ...
                .build()//
                .execute(new ClassFormatCallBack<User>() {
                    @Override
                    public void onError(Call call, Exception e, int id) {
                        mTv.setText("onError:" + e.getMessage());
                    }
...
//                });
    ...
    public void ads(View view) {
        String url = mBaseUrl02 + "v1/ad/getTvAd/coocaa";
        OkHttpUtils.get().url(url)
                .addHeader("Authorization", "Bearer d2eGZ94xGfxneWRQ")
                .addHeader("Content-Type", "application/x-www-form-urlencoded")
                .build()
                .execute(new ClassFormatCallBack<AlbumADResponse>() {
                    @Override
                    public void onError(Call call, Exception e, int id) {
                        mTv.setText("onError:" + e.getMessage());
                    }
                    ...
                    @Override
                    public void onResponse(AlbumADResponse response, int id) {
                        mTv.setText("onResponse:" + MyApplication.getGson().toJson(response));
                    }
                });
